...
Target: VS Code 1.108.x (source read from a `code-oss-dev@1.108.0` checkout; the links below point at the matching upstream tag, so line numbers may drift slightly against other builds).
...
| A new "window" config scope | Doesn't exist. `ConfigurationScope.WINDOW` means *"configurable in user or workspace settings"* — both shared. ([configurationRegistry.ts:142-145](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/platform/configuration/common/configurationRegistry.ts#L142-L145)) |
...
`settingsTarget` argument — [themeConfiguration.ts:364-367](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/services/themes/common/themeConfiguration.ts#L364-L367):
...
nothing is written to storage ([workbenchThemeService.ts:521-523](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/services/themes/browser/workbenchThemeService.ts#L521-L523)):
...
[themes.contribution.ts:559](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/contrib/themes/browser/themes.contribution.ts#L559):
...
([colorThemeData.ts:715](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/services/themes/common/colorThemeData.ts#L715)), which is how we resolve a
...
([themes.contribution.ts:575](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/contrib/themes/browser/themes.contribution.ts#L575)). That flag traces to
`ext.description.isBuiltin` ([themeExtensionPoints.ts:200](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/services/themes/common/themeExtensionPoints.ts#L200)),
which is set as ([extensionsScannerService.ts:1031-1032](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/platform/extensionManagement/common/extensionsScannerService.ts#L1031-L1032)):
...
- **Everything else** → falls through to `getMarketplaceColorThemes`, which builds a gallery URL from
  ...
  ([workbenchThemeService.ts:378-389](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/services/themes/browser/workbenchThemeService.ts#L378-L389)). Needs network,
...
([extensionsScannerService.ts:697](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/platform/extensionManagement/common/extensionsScannerService.ts#L697)), and
...
preview intact ([themes.contribution.ts:368-377](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/contrib/themes/browser/themes.contribution.ts#L368-L377)):
...
[workbenchThemeService.ts:247-257](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/workbench/services/themes/browser/workbenchThemeService.ts#L247-L257) — a config event on
...
([argv.ts:111](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/platform/environment/node/argv.ts#L111),
[environmentService.ts:112-114](https://github.com/microsoft/vscode/blob/1.108.0/src/vs/platform/environment/common/environmentService.ts#L112-L114)). Point it at a writable
